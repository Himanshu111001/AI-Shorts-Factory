...
class PipelineService:
    ...
    def process_video(
        ...
        self._report_progress(progress_callback, 35, "Text Generated")
        
        # Step 2: Audio Generation
        self._report_progress(progress_callback, 40, "Generating Audio")
        video = self.audio_service.generate_audio(video_id)
        self._report_progress(progress_callback, 60, "Audio Generated")
        
        # Step 3: Image Generation
        self._report_progress(progress_callback, 65, "Generating Images")
        images = self.image_service.generate_images(video_id)
        self._report_progress(progress_callback, 90, "Images Generated")
